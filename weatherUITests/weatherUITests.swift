...
extension weatherUITests {
    ...
    func testSearchCity() {
        ...
        app.tables/*@START_MENU_TOKEN@*/.staticTexts["Search for cities"]/*[[".cells.staticTexts[\"Search for cities\"]",".staticTexts[\"Search for cities\"]"],[[[-1,1],[-1,0]]],[0]]@END_MENU_TOKEN@*/.tap()
