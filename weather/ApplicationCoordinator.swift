...
class ApplicationCoordinator: NSObject {
    ...
    func start() {
        ...
        // app config
        ApplicationConfiguration.shared.initDefaultValue()
    ...
    func startApplication() {
        ...
        let viewController = ApplicationConfiguration.shared.mainStoryboard.instantiateViewController(withIdentifier: "MainViewController") as? MainViewController ?? MainViewController()
