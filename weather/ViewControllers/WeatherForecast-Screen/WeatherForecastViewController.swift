...
class WeatherForecastViewController: BaseViewController {
    ...
    override func viewWillDisappear(_ animated: Bool) {
        ...
        print("DEINIT")
        LocManager.shared.delegate = nil
    }
...
extension WeatherForecastViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if viewModel.weatherList.count != 0 {
            ...
            // Image
            cell.weatherImageView.sd_setImage(with: URL(string: "http://openweathermap.org/img/wn/\(item.icon)@2x.png"), placeholderImage: UIImage(named: "default.png"))
